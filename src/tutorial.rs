...
fn numbers_example () {
    // numbers (i8, i16, i32, i64, i128, isize, u8, u16, u32, u64, u128, usize, f32, f64)
...
fn tuple_example () {
    ...
    let my_different_tuple = (10.5, String::from("hi"));
}
...
impl Person {
    fn new (name: String, age: u16, gender: Gender) -> Person {
        Person {
            name: name,
            age: age,
            // shortcut syntax
...
fn complex_types_example () {
    ...
    let person = Person::new(String::from("Lexi"), 21, Gender::Female);
